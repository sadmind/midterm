#include <iostream>
#include "s971541_String.h" // include definition of class String
#include "string.h"
using namespace std;
...
friend ostream &operator<<(ostream& output, const String& str){}
	...
	void String::reserve(size_t n = 0){} // Requests that the string capacity be enough to contain n characters.
