...
//friend istream& operator>> (istream& input, string& str); //BOUNS 10pts
	...
	void string::String(const String &str); // Constructs a copy of "str". (copy constructor)

	void string::String(const String& str, size_t pos, size_t len = npos); // (substring constructor)
