...
public:
	...
	String(const String& str, size_t , size_t ); // (substring constructor)
	...
	void reserve(size_t); // Requests that the string capacity be enough to contain n characters.
	...
	size_t find(const String &str, size_t) const;
...
private:
	...
	char *sPtr[100000]; // points to a dynamically allocated array which is used to store the elements of the string
}; // end class String
